  ...
  return (
    <div className="service-section py-16" id="service">
      <div className="container mx-auto px-4">
        <div className="service-card-wrap bg-[#cfdeff] rounded-3xl p-12">
          <div className="service-card-container grid grid-cols-2 items-center gap-8">
            <div className="heading-wrap">
              <h3 dangerouslySetInnerHTML={{__html: t('title')}} className="text-4xl font-bold text-left text-gray-900">
              </h3>
            </div>
            <div className="service-card bg-white rounded-lg p-8">
